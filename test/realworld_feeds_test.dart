  ...
  group('Real-world feed parsing', () {
    ...
    for (var i = 0; i < feedUrls.length; i++) {
      ...
      test('Parse feed #${i+1}: ${url.split('/').last}', () async {
        ...
        if (url.contains('theguardian.com') || url.contains('politico.com') || url.contains('newyorker.com')) {
        ...
        expect(feedContent.isNotEmpty, true, reason: 'Feed content should not be empty');
          ...
          try {
            ...
            if (rssFeed.items != null && rssFeed.items!.isNotEmpty) {
              ...
              if (item.content != null) {
                ...
                print('Content has plain text: ${item.content!.plainText != null}');
              }
            }
